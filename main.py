...
# ⚡ Bolt: Cache heavy TensorFlow model initialization
# Caching prevents loading the model synchronously on every prediction request,
# significantly reducing prediction latency (expected ~90% reduction on subsequent calls).
@st.cache_resource
def load_model():
