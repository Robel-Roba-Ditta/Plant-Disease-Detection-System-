...
# ⚡ Bolt Optimization: Cache the TensorFlow model to prevent synchronous reloading from disk on every prediction.
# Impact: Reduces subsequent prediction latency from seconds to milliseconds.
@st.cache_resource
def load_model():
