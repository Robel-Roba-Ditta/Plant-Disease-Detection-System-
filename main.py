...
# ⚡ Bolt Optimization: Cache the TensorFlow model to prevent reloading on every Streamlit interaction
# Impact: Reduces prediction time from seconds to milliseconds by avoiding repeated disk I/O and model initialization
@st.cache_resource
def load_model():
